# [package:media_kit](https://github.com/agentai2026/Years-kit) · **Years-kit**
...
3. Native **D3D11** renderer on Windows (zero-copy HW accel, no ANGLE)
4. Linux triple-buffering (Vulkan-swapchain style) to reduce black screens / flicker on bad OpenGL drivers
5. [avbuild](https://github.com/wang-bin/avbuild) FFmpeg out-of-tree patches for non-standard streams
6. Newer mpv build with smaller binaries
...
<a href="https://ottomatic.io/" target="_blank">
  <picture>
    ...
    <img alt="Ottomatic" width="200" height="auto" src="https://user-images.githubusercontent.com/28951144/228648844-f2a59ab1-12cd-4fee-bc8d-b2d332033c45.svg">
  </picture>
</a>
<br></br>
<strong>
